...
const addWatermark = (doc: jsPDF) => {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text('Clarity OCR AI 🇮🇳', pageWidth / 2, pageHeight - 10, { align: 'center' });
  }
};
...
export const exportToPdf = (data: AnalysisResult, fileName: string = 'analysis_result') => {
  ...
  // Add footer with app info on last page
  const pageCount = doc.getNumberOfPages();
  doc.setPage(pageCount);
  doc.setFontSize(10);
  doc.setTextColor(100, 100, 100);
  doc.text('Generated by Clarity OCR AI 🇮🇳', doc.internal.pageSize.getWidth() / 2, doc.internal.pageSize.getHeight() - 10, { align: 'center' });
